...
const pkce = exports.pkce = {
    ...
    async use (cookies, resCookies, options, checks) {
        var _options$provider2, _options$provider3;
        ...
        if (value.provider !== ((_options$provider3 = options.provider) === null || _options$provider3 === void 0 ? void 0 : _options$provider3.id)) throw new TypeError(`${name} cookie was created for a different provider than the one handling the callback.`);
        resCookies.push({
            name,
            value: "",
            options: {
...
const state = exports.state = {
    ...
    async use (cookies, resCookies, options, checks) {
        var _options$provider$che2, _options$provider4;
        ...
        if (value.provider !== ((_options$provider4 = options.provider) === null || _options$provider4 === void 0 ? void 0 : _options$provider4.id)) throw new TypeError(`${name} cookie was created for a different provider than the one handling the callback.`);
        resCookies.push({
            name,
            value: "",
            options: {
...
const nonce = exports.nonce = {
    ...
    async use (cookies, resCookies, options, checks) {
        var _options$provider5, _options$provider6;
        if (!((_options$provider5 = options.provider) !== null && _options$provider5 !== void 0 && (_options$provider5 = _options$provider5.checks) !== null && _options$provider5 !== void 0 && _options$provider5.includes("nonce"))) return;
        ...
        if (value.provider !== ((_options$provider6 = options.provider) === null || _options$provider6 === void 0 ? void 0 : _options$provider6.id)) throw new TypeError(`${name} cookie was created for a different provider than the one handling the callback.`);
        resCookies.push({
            name,
            value: "",
            options: {
...
var _uuid = __turbopack_context__.r("[project]/node_modules/uuid/dist/cjs/index.js [app-route] (ecmascript)");
var _cookie = __turbopack_context__.r("[project]/node_modules/next-auth/core/lib/cookie.js [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_next-auth_1xkmtzw._.js.map